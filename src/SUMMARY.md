...
- [About this Note](./about_this_note.md)
...
- [Network](./network/index.md)
  - [High-Performance Networking](./network/high_performance_networking.md)
  - [Segment Routing](./network/segment_routing.md)
  - [create Router](./network/create_router.md)
